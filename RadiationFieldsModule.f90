MODULE RadiationFieldsModule
  ...
  ! --- Flavor Non-Diagonal Indices
  INTEGER, PUBLIC, PARAMETER :: iNuEE     = 1
  INTEGER, PUBLIC, PARAMETER :: iNuEX     = 2
  INTEGER, PUBLIC, PARAMETER :: iNuXX     = 3
  INTEGER, PUBLIC, PARAMETER :: iNuEE_Bar = 4
  INTEGER, PUBLIC, PARAMETER :: iNuEX_Bar = 5
  INTEGER, PUBLIC, PARAMETER :: iNuXX_Bar = 6
